                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      minLength={8}
                      maxLength={12}
                      className="w-full px-4 py-3 pr-12 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all outline-none text-gray-900"
